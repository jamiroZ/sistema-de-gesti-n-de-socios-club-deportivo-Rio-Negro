...
CREATE TABLE usuario (
    ...
    tipo_dni       VARCHAR(10) NOT NULL CHECK (tipo_dni IN ('DNI','LE','LC','CI','PASAPORTE')),
...
CREATE TABLE tiene_tutor (
    tipo_dni_socio VARCHAR(10) CHECK (tipo_dni_socio IN ('DNI','LE','LC','CI','PASAPORTE')),
    nro_dni_socio  VARCHAR(15),
    tipo_dni_tutor VARCHAR(10) NOT NULL CHECK (tipo_dni_tutor IN ('DNI','LE','LC','CI','PASAPORTE')),
...
CREATE TABLE seguro (
    ...
    tipo_dni_socio     VARCHAR(10) NOT NULL CHECK (tipo_dni_socio IN ('DNI','LE','LC','CI','PASAPORTE')),
...
CREATE TABLE tiene_cargo (
    ...
    nro_dni            VARCHAR(15),
    id_cargo           INT,
    fecha_inicio_cargo DATE CHECK (fecha_inicio_cargo >= '2015-05-07'),
