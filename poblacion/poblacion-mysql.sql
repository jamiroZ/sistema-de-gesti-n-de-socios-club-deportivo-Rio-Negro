-- =============================================================================
-- Club Deportivo Rio Negro - Poblacion MySQL - esq_grupo4
-- =============================================================================
...
-- Marina llega a 5 ausencias consecutivas, que es el umbral que fija el EDR
...
-- La póliza de Marina es la única con fecha de baja.
...
-- -----------------------------------------------------------------------------
-- Mismo motivo que en PostgreSQL. Los identificadores se cargaron a mano, asi
-- que hay que decirle al AUTO_INCREMENT por donde seguir.

ALTER TABLE notificacion         AUTO_INCREMENT = 6;
ALTER TABLE planilla_asistencia  AUTO_INCREMENT = 7;
ALTER TABLE cuota                AUTO_INCREMENT = 9;
ALTER TABLE pago                 AUTO_INCREMENT = 5;
ALTER TABLE cargo_administrativo AUTO_INCREMENT = 4;
